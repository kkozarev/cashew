...
;Finds the mean and stddev of all the events
     ...
     rad_data=rad_data_average
                                ;rad_stdv={speed:{front:stdfrontspeed,peak:stdpeakspeed,back:stdbackspeed},$
                                ;          accel:{front:stdfrontaccel,peak:stdpeakaccel,back:stdbackaccel},$
                                ;          intensity:stdintensity,wav_thick:wav_thick_std}

     rad_stdv={front:replicate({speed:0.,accel:0.},ntimes),$
               peak:replicate({speed:0.,accel:0.},ntimes),$
               back:replicate({speed:0.,accel:0.},ntimes),$
               intensity:fltarr(ntimes),wav_thick:fltarr(ntimes)}
     rad_stdv.front.speed = stdfrontspeed
     rad_stdv.front.accel = stdfrontaccel
     rad_stdv.peak.speed = stdpeakspeed
     rad_stdv.peak.accel = stdpeakaccel
     rad_stdv.back.speed = stdbackspeed
     rad_stdv.back.accel = stdbackaccel
     rad_stdv.intensity = stdintensity
     rad_stdv.wav_thick = wav_thick_std
     
     
     save,filename=shockfile,rad_data,ind_arr,annulus_info,rad_stdv
     ...
     stdintensity = rad_stdv.intensity
     wav_thick = rad_data.wavethick
     wav_thick_std = rad_stdv.wav_thick
     stdfrontaccel=rad_stdv.front.accel
     stdpeakaccel=rad_stdv.peak.accel
     stdbackaccel=rad_stdv.back.accel
     stdfrontspeed=rad_stdv.front.speed
     stdpeakspeed=rad_stdv.peak.speed
     stdbackspeed=rad_stdv.back.speed
  endelse
