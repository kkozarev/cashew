pro fitdata_prep_lateral,lat_data,plotinfo
...
;ADDITIONAL PROCESSING WITH HISTOGRAM SELECTION AND ATROUS sharpening
  ...
  sm=smooth(diffdata,[12,1],/edge_truncate)
...
;Subtract this average profile to get rid of horizontal striping
  ...
  aia_plot_jmap_data,time.jd,lat_data.x_deg_array[yrng[0]:yrng[1]],$
                     ...
                     ytitle=plotinfo.ytitle
 ; wdef,3,1000,800
 ; aia_plot_jmap_data,time.jd,lat_data.y_rsun_array[yrng[0]:yrng[1]],$
