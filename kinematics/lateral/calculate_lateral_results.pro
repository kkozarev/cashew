pro test_calculate_lateral_results
;A little program to test the calculate_radial_results procedure
  ...
  for ev=0,nevents-1 do begin
     ...
     calculate_lateral_results,event,/ps 
  endfor
end
...
pro calculate_lateral_results,event,ps=ps
...
;Finds the mean and stddev of all the events
        ...
        for tt=0,ntimes-1 do begin
           lat_data_average[rr,dir].wave_frontedge[tt].lat=mean(alllat_data[*,rr,dir].wave_frontedge[tt].lat)
           lat_data_average[rr,dir].wave_frontedge[tt].stdv=stddev(alllat_data[*,rr,dir].wave_frontedge[tt].lat)
           lat_data_average[rr,dir].wave_backedge[tt].lat=mean(alllat_data[*,rr,dir].wave_backedge[tt].lat)
           lat_data_average[rr,dir].wave_backedge[tt].stdv=stddev(alllat_data[*,rr,dir].wave_backedge[tt].lat)
           lat_data_average[rr,dir].wave_peak[tt].lat=mean(alllat_data[*,rr,dir].wave_peak[tt].lat)
...
;This may need updating in the future
        xrnge = [lat_data.time[sp].relsec, lat_data.time[ep].relsec]
...
;=====================================================================================
        ...
        aia_plot_jmap_data,time.jd,yarray[yrng[0]:yrng[1]],smoothdata[*,yrng[0]:yrng[1]],min=-10,max=20,$
                           title='AIA/193 Mean Tangential positions',$
...
;----------------------PLOT THE WAVE ACCELERATION---------------------------
        ...
        plot, timesec[sp:ep], lat_data_average[rr,dir].savgolfits.front[sp:ep].accel, thick=linethick, $
        ...
        oplot, timesec[sp:ep], lat_data_average[rr,dir].savgolfits.back[sp:ep].accel, thick=linethick, color = cback
        oplot, timesec[sp:ep], lat_data_average[rr,dir].savgolfits.back[sp:ep].accel,psym=sym(1),symsize=0.8,color=cback
        oploterr, timesec[sp:ep], lat_data_average[rr,dir].savgolfits.back[sp:ep].accel, stdbackaccel[sp:ep], errcolor = cback, errthick = 4, /noconnect
        oplot,timesec[sp:ep],fltarr(ep-sp+1)+mean(lat_data_average[rr,dir].savgolfits.back[sp:ep].accel), thick=linethick, color = cback
        ;print,mean(lat_data_average[rr,dir].savgolfits.back[sp:ep].accel)
        
        oplot, timesec[sp:ep], lat_data_average[rr,dir].savgolfits.front[sp:ep].accel, thick=linethick, color = cfront
        oplot, timesec[sp:ep], lat_data_average[rr,dir].savgolfits.front[sp:ep].accel,psym=sym(1),symsize=0.8,color=cfront
        oploterr, timesec[sp:ep], lat_data_average[rr,dir].savgolfits.front[sp:ep].accel, stdfrontaccel[sp:ep], errcolor = cfront, errthick = 4, /noconnect
        oplot,timesec[sp:ep],fltarr(ep-sp+1)+mean(lat_data_average[rr,dir].savgolfits.front[sp:ep].accel), thick=linethick, color = cfront
        ;print,mean(lat_data_average[rr,dir].savgolfits.front[sp:ep].accel)
        
        oplot, timesec[sp:ep], lat_data_average[rr,dir].savgolfits.peak[sp:ep].accel, thick=linethick, color = cpeak
        oplot, timesec[sp:ep], lat_data_average[rr,dir].savgolfits.peak[sp:ep].accel,psym=sym(1),symsize=0.8,color=cpeak
        oploterr, timesec[sp:ep], lat_data_average[rr,dir].savgolfits.peak[sp:ep].accel, stdpeakaccel[sp:ep], errcolor = cpeak, errthick = 4, /noconnect
        oplot,timesec[sp:ep],fltarr(ep-sp+1)+mean(lat_data_average[rr,dir].savgolfits.peak[sp:ep].accel), thick=linethick, color = cpeak
        ;print,mean(lat_data_average[rr,dir].savgolfits.peak[sp:ep].accel)
...
;----------------------PLOT THE WAVE SPEEDS---------------------------
        ...
        plot, timesec[sp:ep], lat_data_average[rr,dir].savgolfits.back[sp:ep].speed, thick=linethick, /xstyle, color = 0, background = 255,$
        ...
        xyouts, !p.position[0]+0.012, !p.position[3]-2*strdy, 'Peak', color = cpeak, /normal, charsize = 1.3, charthick = 1.5
        xyouts, !p.position[0]+0.012, !p.position[3]-3*strdy, 'Back', color = cback, /normal, charsize = 1.3, charthick = 1.5
        oplot, timesec[sp:ep], lat_data_average[rr,dir].savgolfits.back[sp:ep].speed, thick=linethick, color = cback
        oplot, timesec[sp:ep], lat_data_average[rr,dir].savgolfits.back[sp:ep].speed,psym=sym(1),symsize=0.8,color=cback
        oploterr, timesec[sp:ep], lat_data_average[rr,dir].savgolfits.back[sp:ep].speed, stdbackspeed[sp:ep], errcolor = cback, errthick = 4, /noconnect
        oplot,timesec[sp:ep],fltarr(ep-sp+1)+mean(lat_data_average[rr,dir].savgolfits.back[sp:ep].speed), thick=linethick, color = cback
        ;print,mean(lat_data_average[rr,dir].savgolfits.back[sp:ep].speed)
        
        oplot, timesec[sp:ep], lat_data_average[rr,dir].savgolfits.front[sp:ep].speed, thick=linethick, color = cfront
        oplot, timesec[sp:ep], lat_data_average[rr,dir].savgolfits.front[sp:ep].speed,psym=sym(1),symsize=0.8,color=cfront
        oploterr, timesec[sp:ep], lat_data_average[rr,dir].savgolfits.front[sp:ep].speed, stdfrontspeed[sp:ep], errcolor = cfront, errthick = 4, /noconnect
        oplot,timesec[sp:ep],fltarr(ep-sp+1)+mean(lat_data_average[rr,dir].savgolfits.front[sp:ep].speed), thick=linethick, color = cfront
        ;print,mean(lat_data_average[rr,dir].savgolfits.front[sp:ep].speed)
        
        oplot, timesec[sp:ep], lat_data_average[rr,dir].savgolfits.peak[sp:ep].speed, thick=linethick, color = cpeak
        oplot, timesec[sp:ep], lat_data_average[rr,dir].savgolfits.peak[sp:ep].speed,psym=sym(1),symsize=0.8,color=cpeak
        oploterr, timesec[sp:ep], lat_data_average[rr,dir].savgolfits.peak[sp:ep].speed, stdpeakspeed[sp:ep], errcolor = cpeak, errthick = 4, /noconnect
        oplot,timesec[sp:ep],fltarr(ep-sp+1)+mean(lat_data_average[rr,dir].savgolfits.peak[sp:ep].speed), thick=linethick, color = cpeak
        ;print,mean(lat_data_average[rr,dir].savgolfits.peak[sp:ep].speed)
        loadct, 0, /silent
...
;----------------------PLOT THE WAVE POSITIONS---------------------------
        ...
        plot, timesec[sp:ep], lat_data_average[rr,dir].wave_peak[sp:ep].lat,/xstyle, thick = linethick, color = 0, background = 255,$
              ytitle="Tangential position [deg]", xtitle = "Time, seconds", charsize = 3,/ystyle, xthick=linethick,ythick=linethick,$
        ...
        oplot, timesec[sp:ep], lat_data_average[rr,dir].wave_backedge[sp:ep].lat, thick=linethick, color = cback
        oplot, timesec[sp:ep], lat_data_average[rr,dir].wave_backedge[sp:ep].lat,psym=sym(1),symsize=0.8,color=cback
        oploterr, timesec[sp:ep], lat_data_average[rr,dir].wave_backedge[sp:ep].lat, lat_data_average[rr,dir].wave_backedge[sp:ep].stdv, $
                  errcolor = cback, errthick = 4, /noconnect
        
        oplot, timesec[sp:ep], lat_data_average[rr,dir].wave_frontedge[sp:ep].lat, thick=linethick,color = cfront
        oplot, timesec[sp:ep], lat_data_average[rr,dir].wave_frontedge[sp:ep].lat,psym=sym(1),symsize=0.8,color=cfront
        oploterr, timesec[sp:ep], lat_data_average[rr,dir].wave_frontedge[sp:ep].lat, lat_data_average[rr,dir].wave_frontedge[sp:ep].stdv, $
                  errcolor = cfront, errthick = 4, /noconnect
        
        oplot, timesec[sp:ep],  lat_data_average[rr,dir].wave_peak[sp:ep].lat, thick=linethick,color = cpeak ;lat_data_average.wave_peak[sp:ep].lat
        oplot, timesec[sp:ep], lat_data_average[rr,dir].wave_peak[sp:ep].lat,psym=sym(1),symsize=0.8,color=cpeak ;lat_data_average.wave_peak[sp:ep].lat
        oploterr, timesec[sp:ep], lat_data_average[rr,dir].wave_peak[sp:ep].lat, lat_data_average[rr,dir].wave_peak[sp:ep].stdv, $
...
;----------------------Save the 5 graph plot-----------------
  ...
  save,filename=shockfile,lat_data,ind_arr,annulus_info,event
