...
path='/home/kkozarev/Desktop/temp/radiodata/newfit/'
plotit=0
...
;=======================================================================
;20100613 upper (AKA fundamental)
;=======================================================================
...
plot,up0613.time-up0613[0].time,up0613.ravg/rsun,/ynozero,psym=2,$
     title='radio fits, 06132010 - fundamental emission',xtitle='Seconds since '+str(up0613[0].time)+' sec',$
     ytitle='Rsun',ythick=2,xthick=2,symsize=2,charsize=2.6,charthick=3
