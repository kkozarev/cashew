...
;                For example, infile=event.pfsspath+'model_shock_vsh_400.0_r_1.13.sav'
;
;OUTPUTS:
;
; 
...
;
  ...
  if not keyword_set(infile) then infile=find_latest_file(event.pfsspath+'model_shock_vsh_*')
