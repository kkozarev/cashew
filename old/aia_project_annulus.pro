pro test_aia_project_annulus
;Test the annulus projection, explore the lateral vs. radial speeds
wav='193'
...
pro aia_project_annulus, files, ring_width, projdata, norm=norm, rawplot=rawplot, diffplot=diffplot, loud=loud,latrange=latrange,latzero=latzero, resolution=resolution,savepath=savepath
;PURPOSE:
