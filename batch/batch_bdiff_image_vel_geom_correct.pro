pro batch_bdiff_image_vel_geom_correct
...
eventfile=path+'06122010/results/193/bdiffim/vel_pos_extract_params_2010-06-12_193.sav'
aia_bdiff_image_geom_correct,totaldata,indices,[8,34],eventfile,arlon,proflocs,$
                           outpath=path+'06122010/results/193/bdiffim/gcor/'


;211 A
restore,path+'06122010/results/211/regionData_0612_211.sav'
eventfile=path+'06122010/results/211/bdiffim/vel_pos_extract_params_2010-06-12_211.sav'
aia_bdiff_image_geom_correct,totaldata,indices,[8,35],eventfile,arlon,proflocs,$
...
eventfile=path+'06132010/results/193/bdiffim/vel_pos_extract_params_2010-06-13_193.sav'
aia_bdiff_image_geom_correct,totaldata,indices,[37,54],eventfile,arlon,proflocs,$
                           outpath=path+'06132010/results/193/bdiffim/gcor/'

;211 A
restore,path+'06132010/results/211/regionData_0613_211.sav'
eventfile=path+'06132010/results/211/bdiffim/vel_pos_extract_params_2010-06-13_211.sav'
aia_bdiff_image_geom_correct,totaldata,indices,[37,54],eventfile,arlon,proflocs,$
