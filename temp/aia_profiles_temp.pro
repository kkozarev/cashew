pro aia_profiles_temp,data,indices,framerange,proflocs,nms,checkbad=checkbad,titprefix=titprefix,outpath=outpath
...
for n=0,nms-1 do begin
    ...
    for i=init,fin do begin
        ...
        plots,proflocs[20,0,*],proflocs[20,1,*],/device,thick=4
        if n eq 0 and keyword_set(outpath) then write_png,outpath+'basediff0612_'+wav+'_'+strtrim(string(i+1000),2)+'.png',tvrd()
