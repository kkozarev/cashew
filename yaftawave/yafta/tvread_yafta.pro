...
;
;       THIS VERSION RENAMED BY BRIAN WELSCH, 01 APRIL 2009, TO
;       AVOID CONFLICTS WITH OTHER VERSIONS OF FANNING'S CODE,
;       ONE OF WHICH COMES BUNDLED WITH SSWIDL (AS OF LATE 2008).
;
; CATEGORY:
;
;       Graphics
...
; CALLING SEQUENCE:
;
;       image = TVREAD_YAFTA(xstart, ystart, ncols, nrows)
;
...
;       Renamed program to "tvread_yafta.pro", 01 APR 2009, B.T. Welsch
;-
;
;###########################################################################
;
...
FUNCTION TVREAD_YAFTA, xstart, ystart, ncols, nrows, $
   BMP=bmp, $
   Cancel=cancel, $
   Colors=colors, $
   Cube=cube, $
