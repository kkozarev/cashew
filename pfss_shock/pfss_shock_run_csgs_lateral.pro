;+--------------------------------------------------------------------
pro test_pfss_shock_run_csgs_lateral
...
; model.
  ...
  labels=['151104_01']
    for ev=0,n_elements(labels)-1 do begin
      ...
      pfss_shock_run_csgs_lateral,event,/lores
      ;pfss_shock_plot_all,event,/lores,/force
      ;pfss_shock_run_csgs_lateral,event,/lores,/newtimes
...
;+--------------------------------------------------------------------
pro pfss_shock_run_csgs_lateral,event,plot=plot,png=png,hires=hires,lores=lores,newtimes=newtimes
;This procedure runs the pfss/shock model for estimating shock
;orientation to magnetic fields, based on lateral wave position measurements 
;PURPOSE:
...
;Written by Kamen Kozarev, 05/25/2017
;
  resolve_routine,'sym',/either,/compile_full_file
  
;LOAD DATA
  print,''
  print,'Executing pfss_shock_run_csgs_lateral...'
